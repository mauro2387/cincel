          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-gray-400 hover:text-primary transition-colors text-sm focus:outline-none focus:text-primary"
                >
                  Inicio
                </Link>
              </li>
            ...
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="flex items-center gap-2 text-gray-400 hover:text-primary transition-colors text-sm focus:outline-none focus:text-primary w-full text-left"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-gray-400 hover:text-primary transition-colors text-sm focus:outline-none focus:text-primary"
                >
